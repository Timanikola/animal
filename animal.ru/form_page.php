...
<head>
    ...
    <!-- <script defer src="js/fetchInfo.js"></script> -->
</head>
<body>
    <header>
    ...
    <main>
        <section class="mainSection">
            ...
            <div class="linkButtons">
                ...
                <!-- <button class="custom-btn btn-14" onclick="document.location='coordinates.php'">coordinates</button> -->
                <button class="custom-btn btn-14" onclick="document.location='add_type.php'">add type</button>
                <button class="custom-btn btn-14" onclick="document.location='my_type.php'">my type</button>
                <button id="map-btn" class="custom-btn btn-14" onclick="document.location='map.php'">map</button>                
            </div>
