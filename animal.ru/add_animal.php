...
<body>
    <main>
        ...
        <form action="end_add_animal.php" method="post" enctype="multipart/form-data">
        ...
        <input required type="number" name="lenth" placeholder="Длинна"><br>
        <br>
            <label for="">Высота</label><br>
        <input required type="number" name="height" placeholder="Высота"><br>
        <br>
